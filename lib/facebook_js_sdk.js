  ...
  ui: function(params, cb, fail) {
    ...
    if (FB._nativeInterface) {
        switch (params.method) {
            case 'auth.login':
                FB._nativeInterface.login(params, cb, fail);
                break;
            ...
            case 'permissions.oauth':
                ...
                break;
            case 'auth.logout':
                FB._nativeInterface.logout(cb, fail);
                break;
            case 'auth.status':
                FB._nativeInterface.getLoginStatus(cb, fail);
                break;
            case 'login.status':
                FB._nativeInterface.getLoginStatus(cb, fail);
                break;
            case 'feed':
                FB._nativeInterface.dialog(params, cb, fail);
                break;
            case 'apprequests':
                FB._nativeInterface.dialog(params, cb, fail);
            break;
